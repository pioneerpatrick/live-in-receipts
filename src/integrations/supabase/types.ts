    ...
    Tables: {
      ...
      cancelled_sales: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "cancelled_sales_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      employee_deductions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "employee_deductions_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      plots: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "plots_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      statutory_rates: {
        ...
        Relationships: [
          {
            foreignKeyName: "statutory_rates_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
