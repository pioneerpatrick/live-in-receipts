            ...
            <form onSubmit={form.handleSubmit(handleGenerateReceipt)} className="space-y-4">
              ...
              <div className="bg-accent/30 rounded-lg p-4 mt-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className={`text-xl font-bold ${newBalance === 0 ? 'text-primary' : 'text-foreground'}`}>
                    {formatCurrency(newBalance)}
                  </span>
                </div>
                {newBalance === 0 && (
                  <p className="text-sm text-primary mt-1">🎉 This payment will complete the balance!</p>
                )}
              </div>
            ...
            <>
              ...
              <div className="bg-card border border-border rounded-lg p-6 space-y-4">
                <div className="text-center border-b pb-4">
                  <h3 className="font-heading text-lg font-bold text-secondary">LIVE-IN PROPERTIES</h3>
                  <p className="text-sm text-muted-foreground">Genuine plots with ready title deeds</p>
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <span className="text-muted-foreground">Client:</span>
                  <span className="font-medium">{receiptData.clientName}</span>
                  <span className="text-muted-foreground">Phone:</span>
                  <span>{receiptData.clientPhone}</span>
                  <span className="text-muted-foreground">Project:</span>
              ...
              <div className="flex justify-end gap-3">
                <Button type="button" variant="outline" onClick={() => setReceiptData(null)}>
                  Edit Details
                </Button>
                <Button type="button" variant="secondary" onClick={handlePrintPDF} className="gap-2">
                  <Printer className="w-4 h-4" />
                  Print PDF
                </Button>
                <Button type="button" onClick={handleConfirmAndSave} className="gap-2">
